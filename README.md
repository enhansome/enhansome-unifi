...
* [thib3113/unifi-client](https://github.com/thib3113/unifi-client) ⭐ 47 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-15 - Node.js client for UniFi products.
...
* [Ozark-Connect/NetworkOptimizer](https://github.com/Ozark-Connect/NetworkOptimizer) ⭐ 1,011 | 🐛 70 | 🌐 C# | 📅 2026-09-15 - Self-hosted performance optimization and security audit tool for UniFi Networks.
...
* [Crosstalk-Solutions/unifi-toolkit](https://github.com/Crosstalk-Solutions/unifi-toolkit) ⭐ 515 | 🐛 9 | 🌐 Python | 📅 2026-04-27 - Suite of tools for UniFi network management.
* [hyperb1iss/unifly](https://github.com/hyperb1iss/unifly) ⭐ 257 | 🐛 1 | 🌐 Rust | 📅 2026-08-07 - Rust CLI and TUI for managing UniFi controllers via dual Integration and Legacy APIs with real-time WebSocket events.
...
* [jacobalberty/unifi-docker](https://github.com/jacobalberty/unifi-docker) ⭐ 2,619 | 🐛 20 | 🌐 Shell | 📅 2026-09-11 - UniFi Docker files.
* [linuxserver/docker-unifi-network-application](https://github.com/linuxserver/docker-unifi-network-application) ⭐ 1,173 | 🐛 6 | 🌐 Dockerfile | 📅 2026-09-15 - LinuxServer.io Docker image for UniFi Network Application.
...
* [unpoller/unpoller](https://github.com/unpoller/unpoller) ⭐ 2,712 | 🐛 3 | 🌐 Go | 📅 2026-09-16 - Collect all UniFi Controller, site, device, and client data and export to InfluxDB or Prometheus.
...
* [carverauto/serviceradar](https://github.com/carverauto/serviceradar) ⭐ 917 | 🐛 321 | 🌐 Elixir | 📅 2026-09-16 - Zero-trust open-source network management and observability platform with UniFi support.
...
* [imhotep/hass-unifi-access](https://github.com/imhotep/hass-unifi-access) ⭐ 185 | 🐛 1 | 🌐 Python | 📅 2026-07-21 - UniFi Access Integration for Home Assistant.
...
* [ruaan-deysel/ha-unifi-insights](https://github.com/ruaan-deysel/ha-unifi-insights) ⭐ 42 | 🐛 8 | 🌐 Python | 📅 2026-09-16 - Comprehensive Home Assistant custom integration for UniFi Network and Protect.
...
* [hjdhjd/homebridge-unifi-protect](https://github.com/hjdhjd/homebridge-unifi-protect) ⭐ 1,780 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-19 - Complete HomeKit integration for all UniFi Protect device types with full support for HomeKit Secure Video.
...
* [willswire/unifi-ddns](https://github.com/willswire/unifi-ddns) ⭐ 1,286 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-16 - Cloudflare DDNS (Dynamic DNS) support for UniFi OS.
* [kashalls/external-dns-unifi-webhook](https://github.com/kashalls/external-dns-unifi-webhook) ⭐ 322 | 🐛 2 | 🌐 Go | 📅 2026-09-12 - External-DNS Webhook to manage UniFi DNS Records.
...
* [SierraSoftworks/tailscale-udm](https://github.com/SierraSoftworks/tailscale-udm) ⭐ 1,717 | 🐛 1 | 🌐 Shell | 📅 2026-09-06 - Run Tailscale on your UniFi Dream Machine.
...
* [fabianishere/udm-iptv](https://github.com/fabianishere/udm-iptv) ⭐ 627 | 🐛 26 | 🌐 Shell | 📅 2025-06-22 - Helper tool for configuring routed IPTV on the UniFi Dream Machine (Pro).
...
* [sirkirby/unifi-mcp](https://github.com/sirkirby/unifi-mcp) ⭐ 824 | 🐛 19 | 🌐 Python | 📅 2026-09-16 - MCP server for the UniFi suite including Network, Protect, Access, and Drive.
...
* [enuno/unifi-mcp-server](https://github.com/enuno/unifi-mcp-server) ⭐ 259 | 🐛 5 | 🌐 Python | 📅 2026-09-06 - MCP server that leverages the official UniFi API.

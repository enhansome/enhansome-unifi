...
* [Ozark-Connect/NetworkOptimizer](https://github.com/Ozark-Connect/NetworkOptimizer) ⭐ 969 | 🐛 68 | 🌐 C# | 📅 2026-08-21 - Self-hosted performance optimization and security audit tool for UniFi Networks.
...
* [goofball222/unifi](https://github.com/goofball222/unifi) ⭐ 322 | 🐛 3 | 🌐 Shell | 📅 2026-08-18 - UniFi Docker Container.
...
* [carverauto/serviceradar](https://github.com/carverauto/serviceradar) ⭐ 911 | 🐛 295 | 🌐 Elixir | 📅 2026-08-21 - Zero-trust open-source network management and observability platform with UniFi support.
...
* [hassio-addons/addon-unifi](https://github.com/hassio-addons/addon-unifi) ⭐ 376 | 🐛 3 | 🌐 Dockerfile | 📅 2026-08-21 - UniFi Network Application - Home Assistant Community Add-ons.
...
* [ufozone/ha-unifi-voucher](https://github.com/ufozone/ha-unifi-voucher) ⭐ 80 | 🐛 3 | 🌐 Python | 📅 2026-08-21 - UniFi Hotspot Manager Integration.
...
* [keshavdv/unifi-cam-proxy](https://github.com/keshavdv/unifi-cam-proxy) ⭐ 1,869 | 🐛 5 | 🌐 Python | 📅 2026-08-21 - Enable non-Ubiquiti cameras to work with UniFi NVR.
...
* [willswire/unifi-ddns](https://github.com/willswire/unifi-ddns) ⭐ 1,280 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-21 - Cloudflare DDNS (Dynamic DNS) support for UniFi OS.
* [kashalls/external-dns-unifi-webhook](https://github.com/kashalls/external-dns-unifi-webhook) ⭐ 320 | 🐛 2 | 🌐 Go | 📅 2026-08-21 - External-DNS Webhook to manage UniFi DNS Records.
...
* [scyto/multicast-relay](https://github.com/scyto/multicast-relay) ⭐ 61 | 🐛 3 | 🌐 Dockerfile | 📅 2026-08-21 - Multicast-relay Docker for UniFi Dream Machines.
...
* [sirkirby/unifi-mcp](https://github.com/sirkirby/unifi-mcp) ⭐ 725 | 🐛 27 | 🌐 Python | 📅 2026-08-17 - MCP server for the UniFi suite including Network, Protect, Access, and Drive.

...
* [Ozark-Connect/NetworkOptimizer](https://github.com/Ozark-Connect/NetworkOptimizer) ⭐ 990 | 🐛 67 | 🌐 C# | 📅 2026-09-06 - Self-hosted performance optimization and security audit tool for UniFi Networks.
...
* [willswire/unifi-ddns](https://github.com/willswire/unifi-ddns) ⭐ 1,281 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-06 - Cloudflare DDNS (Dynamic DNS) support for UniFi OS.
...
* [SierraSoftworks/tailscale-udm](https://github.com/SierraSoftworks/tailscale-udm) ⭐ 1,706 | 🐛 1 | 🌐 Shell | 📅 2026-09-06 - Run Tailscale on your UniFi Dream Machine.
...
* [iceteaSA/ucg-max-fan-control](https://github.com/iceteaSA/ucg-max-fan-control) ⭐ 245 | 🐛 0 | 🌐 Shell | 📅 2026-08-09 - UXG-Max/Fibre Dynamic Fan Control.
...
* [sirkirby/unifi-mcp](https://github.com/sirkirby/unifi-mcp) ⭐ 791 | 🐛 31 | 🌐 Python | 📅 2026-09-06 - MCP server for the UniFi suite including Network, Protect, Access, and Drive.

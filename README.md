...
* [thib3113/unifi-client](https://github.com/thib3113/unifi-client) ⭐ 47 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-07 - Node.js client for UniFi products.
...
* [unifi-utilities/unifios-utilities](https://github.com/unifi-utilities/unifios-utilities) ⭐ 4,364 | 🐛 0 | 🌐 Shell | 📅 2026-07-31 - Community collection of utilities and enhancements for UniFi OS.
...
* [Ozark-Connect/NetworkOptimizer](https://github.com/Ozark-Connect/NetworkOptimizer) ⭐ 996 | 🐛 66 | 🌐 C# | 📅 2026-09-07 - Self-hosted performance optimization and security audit tool for UniFi Networks.
...
* [57/unifidash](https://github.com/57/unifidash) ⭐ 23 | 🐛 0 | 🌐 PowerShell | 📅 2025-05-24 - CLI leveraging private gateway APIs for network telemetry, DPI, and topology.

## Docker Images

* [jacobalberty/unifi-docker](https://github.com/jacobalberty/unifi-docker) ⭐ 2,616 | 🐛 15 | 🌐 Shell | 📅 2026-09-07 - UniFi Docker files.
* [linuxserver/docker-unifi-network-application](https://github.com/linuxserver/docker-unifi-network-application) ⭐ 1,168 | 🐛 6 | 🌐 Dockerfile | 📅 2026-09-01 - LinuxServer.io Docker image for UniFi Network Application.
...
* [unpoller/unpoller](https://github.com/unpoller/unpoller) ⭐ 2,701 | 🐛 3 | 🌐 Go | 📅 2026-09-07 - Collect all UniFi Controller, site, device, and client data and export to InfluxDB or Prometheus.
...
* [jmasarweh/Unifi-Log-Insights](https://github.com/jmasarweh/Unifi-Log-Insights) ⭐ 272 | 🐛 32 | 🌐 Python | 📅 2026-06-30 - Self-hosted real-time syslog analysis for UniFi gateways with GeoIP enrichment, threat intelligence, and interactive dashboards.
* [carverauto/serviceradar](https://github.com/carverauto/serviceradar) ⭐ 5 | 🐛 308 | 🌐 Elixir | 📅 2026-09-07 - Zero-trust open-source network management and observability platform with UniFi support.

## Home Automation

### Home Assistant

* [hassio-addons/addon-unifi](https://github.com/hassio-addons/addon-unifi) ⭐ 380 | 🐛 4 | 🌐 Dockerfile | 📅 2026-08-27 - UniFi Network Application - Home Assistant Community Add-ons.
...
* [ruaan-deysel/ha-unifi-insights](https://github.com/ruaan-deysel/ha-unifi-insights) ⭐ 40 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - Comprehensive Home Assistant custom integration for UniFi Network and Protect.
...
* [hjdhjd/homebridge-unifi-protect](https://github.com/hjdhjd/homebridge-unifi-protect) ⭐ 1,778 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-19 - Complete HomeKit integration for all UniFi Protect device types with full support for HomeKit Secure Video.
...
* [ioBroker.unifi](https://github.com/iobroker-community-adapters/ioBroker.unifi) ⭐ 67 | 🐛 51 | 🌐 JavaScript | 📅 2026-09-06 - ioBroker adapter for UniFi network devices.

## UniFi Protect

* [keshavdv/unifi-cam-proxy](https://github.com/keshavdv/unifi-cam-proxy) ⭐ 1,870 | 🐛 3 | 🌐 Python | 📅 2026-09-05 - Enable non-Ubiquiti cameras to work with UniFi NVR.
...
* [wolffcatskyy/crowdsec-blocklist-import](https://github.com/wolffcatskyy/crowdsec-blocklist-import) ⭐ 349 | 🐛 4 | 🌐 Python | 📅 2026-09-02 - Import 120k+ IPs from 36 free threat feeds into CrowdSec decisions for UniFi.
* [jmasarweh/Unifi-Log-Insights](https://github.com/jmasarweh/Unifi-Log-Insights) ⭐ 272 | 🐛 32 | 🌐 Python | 📅 2026-06-30 - Real-time syslog analysis for UniFi gateways with AbuseIPDB threat scoring, threat maps, and firewall policy management.
...
* [wolffcatskyy/crowdsec-unifi-parser](https://github.com/wolffcatskyy/crowdsec-unifi-parser) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2026-03-16 - CrowdSec parsers and iptables LOG rules for UniFi Dream Machines.
* [wolffcatskyy/crowdsec-unifi-suite](https://github.com/wolffcatskyy/crowdsec-unifi-suite) ⭐ 8 | 🐛 1 | 🌐 Shell | 📅 2026-03-16 - One-command installer for CrowdSec + UniFi security stack (bouncer + parser + blocklist-import).

## DNS & DDNS

* [willswire/unifi-ddns](https://github.com/willswire/unifi-ddns) ⭐ 1,282 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-07 - Cloudflare DDNS (Dynamic DNS) support for UniFi OS.
...
* [SierraSoftworks/tailscale-udm](https://github.com/SierraSoftworks/tailscale-udm) ⭐ 1,706 | 🐛 2 | 🌐 Shell | 📅 2026-09-06 - Run Tailscale on your UniFi Dream Machine.
...
* [jamesog/tailscale-edgeos](https://github.com/jamesog/tailscale-edgeos) ⭐ 401 | 🐛 3 | 🌐 Shell | 📅 2024-02-14 - Running Tailscale on Ubiquiti EdgeOS.
* [tusc/wireguard-kmod](https://github.com/tusc/wireguard-kmod) ⭐ 342 | 🐛 11 | 🌐 Shell | 📅 2023-03-02 - WireGuard for UDM series routers.
* [evie-lau/Unifi-gateway-wpa-supplicant](https://github.com/evie-lau/Unifi-gateway-wpa-supplicant) ⭐ 108 | 🐛 6 | 📅 2026-07-10 - Set up wpa\_supplicant on UniFi Gateways to bypass the AT\&T modem.
...
* [zhangyoufu/unifi-backup-decrypt](https://github.com/zhangyoufu/unifi-backup-decrypt) ⭐ 244 | 🐛 2 | 🌐 Shell | 📅 2024-05-02 - Decrypt UniFi Network Application backup (.unf to .zip).
...
* [glenndehaan/unifi-voucher-site](https://github.com/glenndehaan/unifi-voucher-site) ⭐ 304 | 🐛 1 | 🌐 EJS | 📅 2026-08-27 - Web platform for generating and managing UniFi network guest vouchers.
...
* [IngmarStein/unifi-sonos-doc](https://github.com/IngmarStein/unifi-sonos-doc) ⭐ 581 | 🐛 3 | 📅 2025-04-06 - How to configure your UniFi network for Sonos.
...
* [iceteaSA/ucg-max-fan-control](https://github.com/iceteaSA/ucg-max-fan-control) ⭐ 246 | 🐛 0 | 🌐 Shell | 📅 2026-08-09 - UXG-Max/Fibre Dynamic Fan Control.
...
* [scyto/multicast-relay](https://github.com/scyto/multicast-relay) ⭐ 64 | 🐛 4 | 🌐 Dockerfile | 📅 2026-08-28 - Multicast-relay Docker for UniFi Dream Machines.
* [dlk3/udm-hacks](https://github.com/dlk3/udm-hacks) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2024-07-06 - Collection of scripts and tweaks for the UniFi Dream Machine Pro.
...
* [johnstonjs/unifios-utils](https://github.com/johnstonjs/unifios-utils) ⭐ 18 | 🐛 0 | 🌐 Shell | 📅 2026-05-24 - Shell utilities for managing services and configurations on UniFi OS.
...
* [sirkirby/unifi-mcp](https://github.com/sirkirby/unifi-mcp) ⭐ 794 | 🐛 25 | 🌐 Python | 📅 2026-09-07 - MCP server for the UniFi suite including Network, Protect, Access, and Drive.
* [jmasarweh/Unifi-Log-Insights](https://github.com/jmasarweh/Unifi-Log-Insights) ⭐ 272 | 🐛 32 | 🌐 Python | 📅 2026-06-30 - MCP server for querying parsed UniFi firewall logs, threat intelligence, and network analytics.
* [enuno/unifi-mcp-server](https://github.com/enuno/unifi-mcp-server) ⭐ 245 | 🐛 3 | 🌐 Python | 📅 2026-09-06 - MCP server that leverages the official UniFi API.

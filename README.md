...
* [unpoller/unifi](https://github.com/unpoller/unifi) ⭐ 154 | 🐛 0 | 🌐 Go | 📅 2026-09-05 - Go library to grab data from a Ubiquiti UniFi Controller (companion library used by UnPoller).
...
* [Ozark-Connect/NetworkOptimizer](https://github.com/Ozark-Connect/NetworkOptimizer) ⭐ 990 | 🐛 68 | 🌐 C# | 📅 2026-09-05 - Self-hosted performance optimization and security audit tool for UniFi Networks.
...
* [Crosstalk-Solutions/unifi-toolkit](https://github.com/Crosstalk-Solutions/unifi-toolkit) ⭐ 511 | 🐛 9 | 🌐 Python | 📅 2026-04-27 - Suite of tools for UniFi network management.
...
* [scyto/docker-UnifiBrowser](https://github.com/scyto/docker-UnifiBrowser) ⭐ 43 | 🐛 0 | 🌐 PHP | 📅 2026-06-11 - Dockerized version of the UniFi API Browser.
...
* [linuxserver/docker-unifi-network-application](https://github.com/linuxserver/docker-unifi-network-application) ⭐ 1,167 | 🐛 6 | 🌐 Dockerfile | 📅 2026-09-01 - LinuxServer.io Docker image for UniFi Network Application.
...
* [unpoller/unpoller](https://github.com/unpoller/unpoller) ⭐ 2,700 | 🐛 3 | 🌐 Go | 📅 2026-09-05 - Collect all UniFi Controller, site, device, and client data and export to InfluxDB or Prometheus.
...
* [jmasarweh/Unifi-Log-Insights](https://github.com/jmasarweh/Unifi-Log-Insights) ⭐ 270 | 🐛 32 | 🌐 Python | 📅 2026-06-30 - Self-hosted real-time syslog analysis for UniFi gateways with GeoIP enrichment, threat intelligence, and interactive dashboards.
...
* [ruaan-deysel/ha-unifi-insights](https://github.com/ruaan-deysel/ha-unifi-insights) ⭐ 40 | 🐛 2 | 🌐 Python | 📅 2026-09-03 - Comprehensive Home Assistant custom integration for UniFi Network and Protect.
...
* [keshavdv/unifi-cam-proxy](https://github.com/keshavdv/unifi-cam-proxy) ⭐ 1,869 | 🐛 3 | 🌐 Python | 📅 2026-09-05 - Enable non-Ubiquiti cameras to work with UniFi NVR.
* [ep1cman/unifi-protect-backup](https://github.com/ep1cman/unifi-protect-backup) ⭐ 868 | 🐛 19 | 🌐 Python | 📅 2026-09-05 - Back up UniFi Protect event clips in realtime to local or cloud storage.
...
* [jmasarweh/Unifi-Log-Insights](https://github.com/jmasarweh/Unifi-Log-Insights) ⭐ 270 | 🐛 32 | 🌐 Python | 📅 2026-06-30 - Real-time syslog analysis for UniFi gateways with AbuseIPDB threat scoring, threat maps, and firewall policy management.
...
* [willswire/unifi-ddns](https://github.com/willswire/unifi-ddns) ⭐ 1,279 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-05 - Cloudflare DDNS (Dynamic DNS) support for UniFi OS.
* [kashalls/external-dns-unifi-webhook](https://github.com/kashalls/external-dns-unifi-webhook) ⭐ 321 | 🐛 2 | 🌐 Go | 📅 2026-09-05 - External-DNS Webhook to manage UniFi DNS Records.
...
* [SierraSoftworks/tailscale-udm](https://github.com/SierraSoftworks/tailscale-udm) ⭐ 1,704 | 🐛 1 | 🌐 Shell | 📅 2026-08-17 - Run Tailscale on your UniFi Dream Machine.
...
* [sirkirby/unifi-mcp](https://github.com/sirkirby/unifi-mcp) ⭐ 785 | 🐛 44 | 🌐 Python | 📅 2026-09-05 - MCP server for the UniFi suite including Network, Protect, Access, and Drive.
* [jmasarweh/Unifi-Log-Insights](https://github.com/jmasarweh/Unifi-Log-Insights) ⭐ 270 | 🐛 32 | 🌐 Python | 📅 2026-06-30 - MCP server for querying parsed UniFi firewall logs, threat intelligence, and network analytics.

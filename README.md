...
* [thib3113/unifi-client](https://github.com/thib3113/unifi-client) ⭐ 46 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-27 - Node.js client for UniFi products.
...
* [Ozark-Connect/NetworkOptimizer](https://github.com/Ozark-Connect/NetworkOptimizer) ⭐ 980 | 🐛 66 | 🌐 C# | 📅 2026-08-28 - Self-hosted performance optimization and security audit tool for UniFi Networks.
...
* [goofball222/unifi](https://github.com/goofball222/unifi) ⭐ 321 | 🐛 3 | 🌐 Shell | 📅 2026-08-27 - UniFi Docker Container.
...
* [unpoller/unpoller](https://github.com/unpoller/unpoller) ⭐ 2,693 | 🐛 1 | 🌐 Go | 📅 2026-08-28 - Collect all UniFi Controller, site, device, and client data and export to InfluxDB or Prometheus.
...
* [ruaan-deysel/ha-unifi-insights](https://github.com/ruaan-deysel/ha-unifi-insights) ⭐ 40 | 🐛 6 | 🌐 Python | 📅 2026-08-29 - Comprehensive Home Assistant custom integration for UniFi Network and Protect.
...
* [willswire/unifi-ddns](https://github.com/willswire/unifi-ddns) ⭐ 1,280 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-28 - Cloudflare DDNS (Dynamic DNS) support for UniFi OS.
...
* [iceteaSA/ucg-max-fan-control](https://github.com/iceteaSA/ucg-max-fan-control) ⭐ 241 | 🐛 0 | 🌐 Shell | 📅 2026-08-09 - UXG-Max/Fibre Dynamic Fan Control.

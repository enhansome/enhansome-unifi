...
* [thib3113/unifi-client](https://github.com/thib3113/unifi-client) ⭐ 47 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-21 - Node.js client for UniFi products.
...
* [unifi-utilities/unifios-utilities](https://github.com/unifi-utilities/unifios-utilities) ⭐ 4,369 | 🐛 0 | 🌐 Shell | 📅 2026-09-21 - Community collection of utilities and enhancements for UniFi OS.
...
* [Ozark-Connect/NetworkOptimizer](https://github.com/Ozark-Connect/NetworkOptimizer) ⭐ 1,016 | 🐛 72 | 🌐 C# | 📅 2026-09-21 - Self-hosted performance optimization and security audit tool for UniFi Networks.
...
* [Crosstalk-Solutions/unifi-toolkit](https://github.com/Crosstalk-Solutions/unifi-toolkit) ⭐ 518 | 🐛 6 | 🌐 Python | 📅 2026-09-21 - Suite of tools for UniFi network management.
...
* [Nico640/docker-unms](https://github.com/Nico640/docker-unms) ⭐ 278 | 🐛 29 | 🌐 Dockerfile | 📅 2026-09-21 - All-in-one Docker image for Ubiquiti UISP (formerly UNMS) - supports x86\_64 and ARM.
...
* [carverauto/serviceradar](https://github.com/carverauto/serviceradar) ⭐ 916 | 🐛 335 | 🌐 Elixir | 📅 2026-09-21 - Zero-trust open-source network management and observability platform with UniFi support.
* [jmasarweh/Unifi-Log-Insights](https://github.com/jmasarweh/Unifi-Log-Insights) ⭐ 282 | 🐛 32 | 🌐 Python | 📅 2026-06-30 - Self-hosted real-time syslog analysis for UniFi gateways with GeoIP enrichment, threat intelligence, and interactive dashboards.
...
* [imhotep/hass-unifi-access](https://github.com/imhotep/hass-unifi-access) ⭐ 185 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - UniFi Access Integration for Home Assistant.
...
* [ruaan-deysel/ha-unifi-insights](https://github.com/ruaan-deysel/ha-unifi-insights) ⭐ 42 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - Comprehensive Home Assistant custom integration for UniFi Network and Protect.
...
* [hjdhjd/homebridge-unifi-protect](https://github.com/hjdhjd/homebridge-unifi-protect) ⭐ 1,785 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-19 - Complete HomeKit integration for all UniFi Protect device types with full support for HomeKit Secure Video.
...
* [ioBroker.unifi](https://github.com/iobroker-community-adapters/ioBroker.unifi) ⭐ 67 | 🐛 56 | 🌐 JavaScript | 📅 2026-09-21 - ioBroker adapter for UniFi network devices.
...
* [jmasarweh/Unifi-Log-Insights](https://github.com/jmasarweh/Unifi-Log-Insights) ⭐ 282 | 🐛 32 | 🌐 Python | 📅 2026-06-30 - Real-time syslog analysis for UniFi gateways with AbuseIPDB threat scoring, threat maps, and firewall policy management.
...
* [willswire/unifi-ddns](https://github.com/willswire/unifi-ddns) ⭐ 1,288 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-21 - Cloudflare DDNS (Dynamic DNS) support for UniFi OS.
...
* [kchristensen/udm-le](https://github.com/kchristensen/udm-le) ⭐ 776 | 🐛 5 | 🌐 Shell | 📅 2026-05-20 - Let's Encrypt support for Ubiquiti UniFi OS.
...
* [sirkirby/unifi-mcp](https://github.com/sirkirby/unifi-mcp) ⭐ 841 | 🐛 19 | 🌐 Python | 📅 2026-09-21 - MCP server for the UniFi suite including Network, Protect, Access, and Drive.
* [jmasarweh/Unifi-Log-Insights](https://github.com/jmasarweh/Unifi-Log-Insights) ⭐ 282 | 🐛 32 | 🌐 Python | 📅 2026-06-30 - MCP server for querying parsed UniFi firewall logs, threat intelligence, and network analytics.
* [enuno/unifi-mcp-server](https://github.com/enuno/unifi-mcp-server) ⭐ 266 | 🐛 7 | 🌐 Python | 📅 2026-09-18 - MCP server that leverages the official UniFi API.

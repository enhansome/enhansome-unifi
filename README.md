...
* [Ozark-Connect/NetworkOptimizer](https://github.com/Ozark-Connect/NetworkOptimizer) ⭐ 1,011 | 🐛 69 | 🌐 C# | 📅 2026-09-15 - Self-hosted performance optimization and security audit tool for UniFi Networks.
...
* [jacobalberty/unifi-docker](https://github.com/jacobalberty/unifi-docker) ⭐ 2,619 | 🐛 19 | 🌐 Shell | 📅 2026-09-11 - UniFi Docker files.
* [linuxserver/docker-unifi-network-application](https://github.com/linuxserver/docker-unifi-network-application) ⭐ 1,172 | 🐛 6 | 🌐 Dockerfile | 📅 2026-09-15 - LinuxServer.io Docker image for UniFi Network Application.
...
* [unpoller/unpoller](https://github.com/unpoller/unpoller) ⭐ 2,709 | 🐛 4 | 🌐 Go | 📅 2026-09-14 - Collect all UniFi Controller, site, device, and client data and export to InfluxDB or Prometheus.
...
* [carverauto/serviceradar](https://github.com/carverauto/serviceradar) ⭐ 3 | 🐛 307 | 🌐 Elixir | 📅 2026-09-15 - Zero-trust open-source network management and observability platform with UniFi support.
...
* [ruaan-deysel/ha-unifi-insights](https://github.com/ruaan-deysel/ha-unifi-insights) ⭐ 42 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - Comprehensive Home Assistant custom integration for UniFi Network and Protect.
...
* [wolffcatskyy/crowdsec-blocklist-import](https://github.com/wolffcatskyy/crowdsec-blocklist-import) ⭐ 361 | 🐛 4 | 🌐 Python | 📅 2026-09-02 - Import 120k+ IPs from 36 free threat feeds into CrowdSec decisions for UniFi.
...
* [willswire/unifi-ddns](https://github.com/willswire/unifi-ddns) ⭐ 1,284 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-15 - Cloudflare DDNS (Dynamic DNS) support for UniFi OS.
...
* [SierraSoftworks/tailscale-udm](https://github.com/SierraSoftworks/tailscale-udm) ⭐ 1,715 | 🐛 1 | 🌐 Shell | 📅 2026-09-06 - Run Tailscale on your UniFi Dream Machine.
...
* [glenndehaan/unifi-voucher-site](https://github.com/glenndehaan/unifi-voucher-site) ⭐ 305 | 🐛 2 | 🌐 EJS | 📅 2026-08-27 - Web platform for generating and managing UniFi network guest vouchers.
...
* [sirkirby/unifi-mcp](https://github.com/sirkirby/unifi-mcp) ⭐ 823 | 🐛 19 | 🌐 Python | 📅 2026-09-14 - MCP server for the UniFi suite including Network, Protect, Access, and Drive.
...
* [enuno/unifi-mcp-server](https://github.com/enuno/unifi-mcp-server) ⭐ 258 | 🐛 5 | 🌐 Python | 📅 2026-09-06 - MCP server that leverages the official UniFi API.

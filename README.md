...
* [thib3113/unifi-client](https://github.com/thib3113/unifi-client) ⭐ 46 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-04 - Node.js client for UniFi products.
...
* [Ozark-Connect/NetworkOptimizer](https://github.com/Ozark-Connect/NetworkOptimizer) ⭐ 989 | 🐛 66 | 🌐 C# | 📅 2026-09-04 - Self-hosted performance optimization and security audit tool for UniFi Networks.
...
* [Crosstalk-Solutions/unifi-toolkit](https://github.com/Crosstalk-Solutions/unifi-toolkit) ⭐ 510 | 🐛 9 | 🌐 Python | 📅 2026-04-27 - Suite of tools for UniFi network management.
...
* [unpoller/unpoller](https://github.com/unpoller/unpoller) ⭐ 2,700 | 🐛 3 | 🌐 Go | 📅 2026-09-03 - Collect all UniFi Controller, site, device, and client data and export to InfluxDB or Prometheus.
...
* [jmasarweh/Unifi-Log-Insights](https://github.com/jmasarweh/Unifi-Log-Insights) ⭐ 269 | 🐛 32 | 🌐 Python | 📅 2026-06-30 - Self-hosted real-time syslog analysis for UniFi gateways with GeoIP enrichment, threat intelligence, and interactive dashboards.
...
* [ufozone/ha-unifi-voucher](https://github.com/ufozone/ha-unifi-voucher) ⭐ 81 | 🐛 1 | 🌐 Python | 📅 2026-09-04 - UniFi Hotspot Manager Integration.
...
* [keshavdv/unifi-cam-proxy](https://github.com/keshavdv/unifi-cam-proxy) ⭐ 1,869 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - Enable non-Ubiquiti cameras to work with UniFi NVR.
* [ep1cman/unifi-protect-backup](https://github.com/ep1cman/unifi-protect-backup) ⭐ 868 | 🐛 20 | 🌐 Python | 📅 2026-05-11 - Back up UniFi Protect event clips in realtime to local or cloud storage.
...
* [hjdhjd/unifi-protect](https://github.com/hjdhjd/unifi-protect) ⭐ 406 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-21 - Comprehensive UniFi Protect API implementation in TypeScript.
...
* [jmasarweh/Unifi-Log-Insights](https://github.com/jmasarweh/Unifi-Log-Insights) ⭐ 269 | 🐛 32 | 🌐 Python | 📅 2026-06-30 - Real-time syslog analysis for UniFi gateways with AbuseIPDB threat scoring, threat maps, and firewall policy management.
...
* [willswire/unifi-ddns](https://github.com/willswire/unifi-ddns) ⭐ 1,279 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-04 - Cloudflare DDNS (Dynamic DNS) support for UniFi OS.
* [kashalls/external-dns-unifi-webhook](https://github.com/kashalls/external-dns-unifi-webhook) ⭐ 321 | 🐛 3 | 🌐 Go | 📅 2026-09-04 - External-DNS Webhook to manage UniFi DNS Records.
...
* [SierraSoftworks/tailscale-udm](https://github.com/SierraSoftworks/tailscale-udm) ⭐ 1,703 | 🐛 1 | 🌐 Shell | 📅 2026-08-17 - Run Tailscale on your UniFi Dream Machine.
...
* [iceteaSA/ucg-max-fan-control](https://github.com/iceteaSA/ucg-max-fan-control) ⭐ 244 | 🐛 0 | 🌐 Shell | 📅 2026-08-09 - UXG-Max/Fibre Dynamic Fan Control.
...
* [esmith443/Verizon-ONT-Bypass](https://github.com/esmith443/Verizon-ONT-Bypass) ⭐ 82 | 🐛 2 | 📅 2026-07-29 - Guide for bypassing the Verizon FiOS ONT with an Iszo XPON UNO on a UDM Pro.
...
* [sirkirby/unifi-mcp](https://github.com/sirkirby/unifi-mcp) ⭐ 780 | 🐛 33 | 🌐 Python | 📅 2026-09-04 - MCP server for the UniFi suite including Network, Protect, Access, and Drive.
* [jmasarweh/Unifi-Log-Insights](https://github.com/jmasarweh/Unifi-Log-Insights) ⭐ 269 | 🐛 32 | 🌐 Python | 📅 2026-06-30 - MCP server for querying parsed UniFi firewall logs, threat intelligence, and network analytics.

...
* [thib3113/unifi-client](https://github.com/thib3113/unifi-client) ⭐ 47 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-14 - Node.js client for UniFi products.
...
* [Ozark-Connect/NetworkOptimizer](https://github.com/Ozark-Connect/NetworkOptimizer) ⭐ 1,010 | 🐛 68 | 🌐 C# | 📅 2026-09-14 - Self-hosted performance optimization and security audit tool for UniFi Networks.
...
* [Crosstalk-Solutions/unifi-toolkit](https://github.com/Crosstalk-Solutions/unifi-toolkit) ⭐ 514 | 🐛 9 | 🌐 Python | 📅 2026-04-27 - Suite of tools for UniFi network management.
* [hyperb1iss/unifly](https://github.com/hyperb1iss/unifly) ⭐ 256 | 🐛 1 | 🌐 Rust | 📅 2026-08-07 - Rust CLI and TUI for managing UniFi controllers via dual Integration and Legacy APIs with real-time WebSocket events.
...
* [jacobalberty/unifi-docker](https://github.com/jacobalberty/unifi-docker) ⭐ 2,618 | 🐛 19 | 🌐 Shell | 📅 2026-09-11 - UniFi Docker files.
* [linuxserver/docker-unifi-network-application](https://github.com/linuxserver/docker-unifi-network-application) ⭐ 1,173 | 🐛 6 | 🌐 Dockerfile | 📅 2026-09-08 - LinuxServer.io Docker image for UniFi Network Application.
...
* [unpoller/unpoller](https://github.com/unpoller/unpoller) ⭐ 2,707 | 🐛 3 | 🌐 Go | 📅 2026-09-14 - Collect all UniFi Controller, site, device, and client data and export to InfluxDB or Prometheus.
...
* [carverauto/serviceradar](https://github.com/carverauto/serviceradar) ⭐ 3 | 🐛 297 | 🌐 Elixir | 📅 2026-09-14 - Zero-trust open-source network management and observability platform with UniFi support.

## Home Automation

### Home Assistant

* [hassio-addons/addon-unifi](https://github.com/hassio-addons/addon-unifi) ⭐ 380 | 🐛 5 | 🌐 Dockerfile | 📅 2026-09-12 - UniFi Network Application - Home Assistant Community Add-ons.
...
* [ruaan-deysel/ha-unifi-insights](https://github.com/ruaan-deysel/ha-unifi-insights) ⭐ 42 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - Comprehensive Home Assistant custom integration for UniFi Network and Protect.
...
* [ep1cman/unifi-protect-backup](https://github.com/ep1cman/unifi-protect-backup) ⭐ 869 | 🐛 20 | 🌐 Python | 📅 2026-09-06 - Back up UniFi Protect event clips in realtime to local or cloud storage.
...
* [petergeneric/unifi-protect-remux](https://github.com/petergeneric/unifi-protect-remux) ⭐ 341 | 🐛 0 | 🌐 Rust | 📅 2026-06-15 - Converts Ubiquiti's proprietary .ubv files into standard MP4 files.
...
* [wolffcatskyy/crowdsec-blocklist-import](https://github.com/wolffcatskyy/crowdsec-blocklist-import) ⭐ 359 | 🐛 4 | 🌐 Python | 📅 2026-09-02 - Import 120k+ IPs from 36 free threat feeds into CrowdSec decisions for UniFi.
...
* [willswire/unifi-ddns](https://github.com/willswire/unifi-ddns) ⭐ 1,284 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-14 - Cloudflare DDNS (Dynamic DNS) support for UniFi OS.
...
* [SierraSoftworks/tailscale-udm](https://github.com/SierraSoftworks/tailscale-udm) ⭐ 1,713 | 🐛 1 | 🌐 Shell | 📅 2026-09-06 - Run Tailscale on your UniFi Dream Machine.
...
* [evie-lau/Unifi-gateway-wpa-supplicant](https://github.com/evie-lau/Unifi-gateway-wpa-supplicant) ⭐ 110 | 🐛 6 | 📅 2026-07-10 - Set up wpa\_supplicant on UniFi Gateways to bypass the AT\&T modem.
...
* [glenndehaan/unifi-voucher-site](https://github.com/glenndehaan/unifi-voucher-site) ⭐ 305 | 🐛 1 | 🌐 EJS | 📅 2026-08-27 - Web platform for generating and managing UniFi network guest vouchers.
...
* [sirkirby/unifi-mcp](https://github.com/sirkirby/unifi-mcp) ⭐ 816 | 🐛 18 | 🌐 Python | 📅 2026-09-14 - MCP server for the UniFi suite including Network, Protect, Access, and Drive.
...
* [enuno/unifi-mcp-server](https://github.com/enuno/unifi-mcp-server) ⭐ 256 | 🐛 5 | 🌐 Python | 📅 2026-09-06 - MCP server that leverages the official UniFi API.
